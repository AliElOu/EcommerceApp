      ...
      child: Row(
        children: [
          ...
          GetBuilder<ProductPageController>(
            builder: (controller) {
              return CustomIconButton(iconPath: "https://raw.githubusercontent.com/GDG-Guelmim/flutter_bootcamp_2023_ecommerce_app/9d0471efd43ce3fa1fb59aec0abdfb005483f9b5/assets/icons/Cart%20Icon.svg",onPressMethod: () => Navigator.pushNamed(context, "cart"),);
            }
          ),
